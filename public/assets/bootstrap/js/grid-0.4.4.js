...
/*
 * Gijgo JavaScript Library v0.4.4
 * http://gijgo.com/
 *
...
﻿gj.grid.private = {
    ...
    CreatePager: function ($grid) {
        var $row, $cell, data, controls, $leftPanel, $rightPanel, $tfoot, leftControls, rightControls;
        ...
        if (data.pager && data.pager.enable) {
            ...
            $grid.append($tfoot);
            gj.grid.private.updatePagerColSpan($grid);
    ...
    updatePagerColSpan: function ($grid) {
        ...
        if ($cell && $cell.length) {
            $cell.attr("colspan", $grid.find("thead > tr > th:visible").length);
        }
    },
...
gj.grid.public = {
    ...
    showColumn: function (field) {
        ...
        if (position > -1) {
            ...
            gj.grid.private.updatePagerColSpan(this);
